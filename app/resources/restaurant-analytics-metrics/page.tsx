...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Restaurant Analytics: Which Metrics Actually Matter for Small Businesses",
    description: "Essential restaurant analytics metrics for independent operators. Food cost, labor %, sales per labor hour, and actionable KPIs that drive profitability.",
    url: "https://snaptrack.io/resources/restaurant-analytics-metrics",
    type: "article",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://snaptrack.io/resources/restaurant-analytics-metrics",
  },
};
    ...
    <ArticleLayout
      ...
      breadcrumbs={[
        ...
        },
        {
                ...
                "href": "/resources/restaurant-analytics-metrics"
        }
]}
    >
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Restaurant Analytics: Which Metrics Actually Matter for Small Businesses",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          },
          {
                    ...
                    "item": "https://snaptrack.io/resources/restaurant-analytics-metrics"
          }
],
          }),
        }}
      ...
      <p className="lead">
        Essential restaurant analytics metrics for independent operators. Food cost, labor %, sales per labor hour, and actionable KPIs that drive profitability.
      </p>

      <h2 id="introduction">Introduction</h2>

      <p>
        This comprehensive guide covers everything you need to know about restaurant analytics. We'll explore industry best practices, proven strategies, and actionable insights from successful operators.
      </p>
      ...
      <p>
        Mastering restaurant analytics requires commitment, consistency, and the right tools. By following the strategies outlined in this guide and avoiding common pitfalls, you'll be well-positioned for success.
      </p>
