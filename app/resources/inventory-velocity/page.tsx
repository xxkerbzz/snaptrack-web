...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Inventory Velocity: How to Calculate and Optimize Turnover Rate",
    description: "Understanding inventory velocity and turnover for restaurants. Calculate inventory days on hand, optimize ordering frequency, and improve cash flow.",
    url: "https://snaptrack.io/resources/inventory-velocity",
    type: "article",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://snaptrack.io/resources/inventory-velocity",
  },
};
    ...
    <ArticleLayout
      ...
      breadcrumbs={[
        ...
        },
        {
                ...
                "href": "/resources/inventory-velocity"
        }
]}
    >
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Inventory Velocity: How to Calculate and Optimize Turnover Rate",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          },
          {
                    ...
                    "item": "https://snaptrack.io/resources/inventory-velocity"
          }
],
          }),
        }}
      ...
      <p className="lead">
        Understanding inventory velocity and turnover for restaurants. Calculate inventory days on hand, optimize ordering frequency, and improve cash flow.
      </p>

      <h2 id="introduction">Introduction</h2>

      <p>
        This comprehensive guide covers everything you need to know about inventory velocity. We'll explore industry best practices, proven strategies, and actionable insights from successful operators.
      </p>
      ...
      <p>
        Mastering inventory velocity requires commitment, consistency, and the right tools. By following the strategies outlined in this guide and avoiding common pitfalls, you'll be well-positioned for success.
      </p>
