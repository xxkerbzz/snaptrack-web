...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Food Truck Health Permits & Licensing: Complete Guide by State",
    description: "Comprehensive guide to food truck health permits and licensing requirements. State-by-state regulations, application process, and maintaining compliance.",
    url: "https://snaptrack.io/resources/food-truck-health-permits",
    type: "article",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://snaptrack.io/resources/food-truck-health-permits",
  },
};
...
export default function Page() {
  return (
    <ArticleLayout
      title="Food Truck Health Permits & Licensing"
      description="Comprehensive guide to food truck health permits and licensing requirements. State-by-state regulations, application process, and maintaining compliance."
      ...
      breadcrumbs={[
        ...
        {
                "label": "Food Truck Health Permits & Licensing",
                "href": "/resources/food-truck-health-permits"
        }
]}
    >
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Food Truck Health Permits & Licensing: Complete Guide by State",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          },
          {
                    "@type": "ListItem",
                    "position": 3,
                    "name": "Food Truck Health Permits & Licensing",
                    "item": "https://snaptrack.io/resources/food-truck-health-permits"
          }
],
          }),
        }}
      ...
      <p className="lead">
        Comprehensive guide to food truck health permits and licensing requirements. State-by-state regulations, application process, and maintaining compliance.
      </p>

      <h2 id="introduction">Introduction</h2>

      <p>
        This comprehensive guide covers everything you need to know about food truck health permits & licensing. We'll explore industry best practices, proven strategies, and actionable insights from successful operators.
      </p>
      ...
      <p>
        Mastering food truck health permits & licensing requires commitment, consistency, and the right tools. By following the strategies outlined in this guide and avoiding common pitfalls, you'll be well-positioned for success.
      </p>
