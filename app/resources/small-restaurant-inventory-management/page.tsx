...
export const metadata: Metadata = {
  ...
  description: "Inventory management solutions designed for small restaurants. Budget-friendly options, simple systems, and strategies that do not require enterprise budgets.",
  ...
  openGraph: {
    title: "Small Restaurant Inventory Management: Systems That Actually Work",
    description: "Inventory management solutions designed for small restaurants. Budget-friendly options, simple systems, and strategies that do not require enterprise budgets.",
    url: "https://snaptrack.io/resources/small-restaurant-inventory-management",
    type: "article",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://snaptrack.io/resources/small-restaurant-inventory-management",
  },
};
...
export default function Page() {
  return (
    <ArticleLayout
      title="Small Restaurant Inventory Management"
      description="Inventory management solutions designed for small restaurants. Budget-friendly options, simple systems, and strategies that do not require enterprise budgets."
      ...
      breadcrumbs={[
        ...
        {
                "label": "Small Restaurant Inventory Management",
                "href": "/resources/small-restaurant-inventory-management"
        }
]}
    >
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Small Restaurant Inventory Management: Systems That Actually Work",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          },
          {
                    "@type": "ListItem",
                    "position": 3,
                    "name": "Small Restaurant Inventory Management",
                    "item": "https://snaptrack.io/resources/small-restaurant-inventory-management"
          }
],
          }),
        }}
      ...
      <p className="lead">
        Inventory management solutions designed for small restaurants. Budget-friendly options, simple systems, and strategies that don't require enterprise budgets.
      </p>

      <h2 id="introduction">Introduction</h2>

      <p>
        This comprehensive guide covers everything you need to know about small restaurant inventory management. We'll explore industry best practices, proven strategies, and actionable insights from successful operators.
      </p>
      ...
      <p>
        Mastering small restaurant inventory management requires commitment, consistency, and the right tools. By following the strategies outlined in this guide and avoiding common pitfalls, you'll be well-positioned for success.
      </p>
