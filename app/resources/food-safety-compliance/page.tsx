...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Food Safety Compliance Guide for Restaurants & Food Trucks",
    description: "Complete guide to food safety compliance for restaurants. Health codes, temperature logs, record keeping, inspections, and avoiding violations.",
    url: "https://snaptrack.io/resources/food-safety-compliance",
    type: "article",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://snaptrack.io/resources/food-safety-compliance",
  },
};
  ...
  return (
    <ArticleLayout
      ...
      breadcrumbs={[
        ...
        {
                "label": "Food Safety Compliance Guide for Restaurants & Food Trucks",
                "href": "/resources/food-safety-compliance"
        }
]}
    >
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Food Safety Compliance Guide for Restaurants & Food Trucks",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          },
          {
                    "@type": "ListItem",
                    "position": 3,
                    "name": "Food Safety Compliance Guide for Restaurants & Food Trucks",
                    "item": "https://snaptrack.io/resources/food-safety-compliance"
          }
],
          }),
        }}
      ...
      <p className="lead">
        Complete guide to food safety compliance for restaurants. Health codes, temperature logs, record keeping, inspections, and avoiding violations.
      </p>

      <h2 id="introduction">Introduction</h2>

      <p>
        This comprehensive guide covers everything you need to know about food safety compliance guide for restaurants & food trucks. We'll explore industry best practices, proven strategies, and actionable insights from successful operators.
      </p>
      ...
      <p>
        Mastering food safety compliance guide for restaurants & food trucks requires commitment, consistency, and the right tools. By following the strategies outlined in this guide and avoiding common pitfalls, you'll be well-positioned for success.
      </p>
