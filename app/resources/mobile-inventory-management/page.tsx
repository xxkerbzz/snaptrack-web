...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Mobile Inventory Management: Apps vs Handheld Scanners",
    description: "Comparing mobile inventory management solutions for restaurants. Smartphone apps, handheld scanners, tablets—which works best for your operation?",
    url: "https://snaptrack.io/resources/mobile-inventory-management",
    type: "article",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://snaptrack.io/resources/mobile-inventory-management",
  },
};
  ...
  return (
    <ArticleLayout
      ...
      breadcrumbs={[
        ...
        {
                "label": "Mobile Inventory Management",
                "href": "/resources/mobile-inventory-management"
        }
]}
    >
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Mobile Inventory Management: Apps vs Handheld Scanners",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          },
          {
                    ...
                    "item": "https://snaptrack.io/resources/mobile-inventory-management"
          }
],
          }),
        }}
      ...
      <p className="lead">
        Comparing mobile inventory management solutions for restaurants. Smartphone apps, handheld scanners, tablets—which works best for your operation?
      </p>

      <h2 id="introduction">Introduction</h2>

      <p>
        This comprehensive guide covers everything you need to know about mobile inventory management. We'll explore industry best practices, proven strategies, and actionable insights from successful operators.
      </p>
      ...
      <p>
        Mastering mobile inventory management requires commitment, consistency, and the right tools. By following the strategies outlined in this guide and avoiding common pitfalls, you'll be well-positioned for success.
      </p>
