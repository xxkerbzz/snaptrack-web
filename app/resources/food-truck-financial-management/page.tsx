...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Food Truck Financial Management: Budgeting & Profitability Guide",
    description: "Complete financial management guide for food trucks. Budgeting, expense tracking, profit optimization, and financial planning for mobile food businesses.",
    url: "https://snaptrack.io/resources/food-truck-financial-management",
    type: "article",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://snaptrack.io/resources/food-truck-financial-management",
  },
};
  ...
  return (
    <ArticleLayout
      ...
      breadcrumbs={[
        ...
        {
                "label": "Food Truck Financial Management",
                "href": "/resources/food-truck-financial-management"
        }
]}
    >
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Food Truck Financial Management: Budgeting & Profitability Guide",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          },
          {
                    "@type": "ListItem",
                    "position": 3,
                    "name": "Food Truck Financial Management",
                    "item": "https://snaptrack.io/resources/food-truck-financial-management"
          }
],
          }),
        }}
      ...
      <p className="lead">
        Complete financial management guide for food trucks. Budgeting, expense tracking, profit optimization, and financial planning for mobile food businesses.
      </p>

      <h2 id="introduction">Introduction</h2>

      <p>
        This comprehensive guide covers everything you need to know about food truck financial management. We'll explore industry best practices, proven strategies, and actionable insights from successful operators.
      </p>
      ...
      <p>
        Mastering food truck financial management requires commitment, consistency, and the right tools. By following the strategies outlined in this guide and avoiding common pitfalls, you'll be well-positioned for success.
      </p>
