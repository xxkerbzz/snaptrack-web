...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Food Safety Record Keeping: Digital vs Paper Systems",
    description: "Best practices for restaurant food safety record keeping. Temperature logs, receiving records, cleaning schedules, and digital documentation systems.",
    url: "https://snaptrack.io/resources/food-safety-record-keeping",
    type: "article",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://snaptrack.io/resources/food-safety-record-keeping",
  },
};
...
export default function Page() {
  return (
    <ArticleLayout
      title="Food Safety Record Keeping"
      description="Best practices for restaurant food safety record keeping. Temperature logs, receiving records, cleaning schedules, and digital documentation systems."
      ...
      breadcrumbs={[
        ...
        {
                "label": "Food Safety Record Keeping",
                "href": "/resources/food-safety-record-keeping"
        }
]}
    >
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "Food Safety Record Keeping: Digital vs Paper Systems",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          },
          {
                    "@type": "ListItem",
                    "position": 3,
                    "name": "Food Safety Record Keeping",
                    "item": "https://snaptrack.io/resources/food-safety-record-keeping"
          }
],
          }),
        }}
      ...
      <p className="lead">
        Best practices for restaurant food safety record keeping. Temperature logs, receiving records, cleaning schedules, and digital documentation systems.
      </p>

      <h2 id="introduction">Introduction</h2>

      <p>
        This comprehensive guide covers everything you need to know about food safety record keeping. We'll explore industry best practices, proven strategies, and actionable insights from successful operators.
      </p>
      ...
      <p>
        Mastering food safety record keeping requires commitment, consistency, and the right tools. By following the strategies outlined in this guide and avoiding common pitfalls, you'll be well-positioned for success.
      </p>
