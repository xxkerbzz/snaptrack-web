...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "How to Calculate and Reduce Food Cost Percentage",
    description: "Master food cost percentage calculation and reduction strategies. Industry benchmarks, formulas, and tactics to improve restaurant profit margins.",
    url: "https://snaptrack.io/resources/food-cost-percentage",
    type: "article",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://snaptrack.io/resources/food-cost-percentage",
  },
};
  ...
  return (
    <ArticleLayout
      ...
      breadcrumbs={[
        ...
        {
                "label": "How to Calculate and Reduce Food Cost Percentage",
    ...
    >
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline: "How to Calculate and Reduce Food Cost Percentage",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          },
          {
                    "@type": "ListItem",
                    "position": 3,
                    "name": "How to Calculate and Reduce Food Cost Percentage",
                    "item": "https://snaptrack.io/resources/food-cost-percentage"
          }
],
          }),
        }}
      ...
      <p className="lead">
        Master food cost percentage calculation and reduction strategies. Industry benchmarks, formulas, and tactics to improve restaurant profit margins.
      </p>

      <h2 id="introduction">Introduction</h2>

      <p>
        This comprehensive guide covers everything you need to know about how to calculate and reduce food cost percentage. We'll explore industry best practices, proven strategies, and actionable insights from successful operators.
      </p>
      ...
      <p>
        Mastering how to calculate and reduce food cost percentage requires commitment, consistency, and the right tools. By following the strategies outlined in this guide and avoiding common pitfalls, you'll be well-positioned for success.
      </p>
