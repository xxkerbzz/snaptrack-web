...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "How to Manage Food Truck Inventory Across Multiple Events",
    description: "Strategies for ordering and managing inventory when serving multiple events per week. Demand forecasting, event-based ordering, and preventing waste.",
    url: "https://snaptrack.io/blog/manage-food-truck-multi-event-inventory",
    type: "article",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://snaptrack.io/blog/manage-food-truck-multi-event-inventory",
  },
};
  ...
  return (
    <ArticleLayout
      ...
      breadcrumbs={[
        ...
        {
                "label": "How to Manage Food Truck Inventory Across Multiple Events",
                "href": "/blog/manage-food-truck-multi-event-inventory"
        }
]}
    >
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "BlogPosting",
            headline: "How to Manage Food Truck Inventory Across Multiple Events",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          },
          {
                    "@type": "ListItem",
                    "position": 3,
                    "name": "How to Manage Food Truck Inventory Across Multiple Events",
                    "item": "https://snaptrack.io/blog/manage-food-truck-multi-event-inventory"
          }
],
          }),
        }}
      ...
      <p className="lead">
        Strategies for ordering and managing inventory when serving multiple events per week. Demand forecasting, event-based ordering, and preventing waste.
      </p>

      <h2 id="introduction">Introduction</h2>

      <p>
        This comprehensive guide covers everything you need to know about how to manage food truck inventory across multiple events. We'll explore industry best practices, proven strategies, and actionable insights from successful operators.
      </p>
      ...
      <p>
        Mastering how to manage food truck inventory across multiple events requires commitment, consistency, and the right tools. By following the strategies outlined in this guide and avoiding common pitfalls, you'll be well-positioned for success.
      </p>
