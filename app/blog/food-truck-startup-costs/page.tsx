...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Food Truck Startup Costs: Complete 2025 Breakdown",
    description: "Detailed breakdown of food truck startup costs including truck purchase, equipment, permits, insurance, and working capital. Real numbers from actual operators.",
    url: "https://snaptrack.io/blog/food-truck-startup-costs",
    type: "article",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://snaptrack.io/blog/food-truck-startup-costs",
  },
};
    ...
    <ArticleLayout
      ...
      breadcrumbs={[
        ...
        },
        {
                ...
                "href": "/blog/food-truck-startup-costs"
        }
]}
    >
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "BlogPosting",
            headline: "Food Truck Startup Costs: Complete 2025 Breakdown",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          },
          {
                    "@type": "ListItem",
                    "position": 3,
                    "name": "Food Truck Startup Costs",
                    "item": "https://snaptrack.io/blog/food-truck-startup-costs"
          }
],
          }),
        }}
      ...
      <p className="lead">
        Detailed breakdown of food truck startup costs including truck purchase, equipment, permits, insurance, and working capital. Real numbers from actual operators.
      </p>

      <h2 id="introduction">Introduction</h2>

      <p>
        This comprehensive guide covers everything you need to know about food truck startup costs. We'll explore industry best practices, proven strategies, and actionable insights from successful operators.
      </p>
      ...
      <p>
        Mastering food truck startup costs requires commitment, consistency, and the right tools. By following the strategies outlined in this guide and avoiding common pitfalls, you'll be well-positioned for success.
      </p>
