...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Hidden Costs of Food Waste on Your P&L Statement",
    description: "How food waste impacts more than just COGS. Labor, disposal, opportunity costs, and the true financial impact on restaurant profit and loss statements.",
    url: "https://snaptrack.io/blog/hidden-costs-food-waste-profit-loss",
    type: "article",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://snaptrack.io/blog/hidden-costs-food-waste-profit-loss",
  },
};
  ...
  return (
    <ArticleLayout
      ...
      breadcrumbs={[
        ...
        {
                "label": "Hidden Costs of Food Waste on Your P&L Statement",
                "href": "/blog/hidden-costs-food-waste-profit-loss"
        }
]}
    >
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "BlogPosting",
            headline: "Hidden Costs of Food Waste on Your P&L Statement",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          },
          {
                    "@type": "ListItem",
                    "position": 3,
                    "name": "Hidden Costs of Food Waste on Your P&L Statement",
                    "item": "https://snaptrack.io/blog/hidden-costs-food-waste-profit-loss"
          }
],
          }),
        }}
      ...
      <p className="lead">
        How food waste impacts more than just COGS. Labor, disposal, opportunity costs, and the true financial impact on restaurant profit and loss statements.
      </p>

      <h2 id="introduction">Introduction</h2>

      <p>
        This comprehensive guide covers everything you need to know about hidden costs of food waste on your p&l statement. We'll explore industry best practices, proven strategies, and actionable insights from successful operators.
      </p>
      ...
      <p>
        Mastering hidden costs of food waste on your p&l statement requires commitment, consistency, and the right tools. By following the strategies outlined in this guide and avoiding common pitfalls, you'll be well-positioned for success.
      </p>
