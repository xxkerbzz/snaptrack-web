...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "How Inventory Mismanagement Destroys Restaurant Profit Margins",
    description: "The profit impact of poor inventory management. Over-ordering, waste, spoilage, and theft—how bad inventory practices kill restaurant margins.",
    url: "https://snaptrack.io/blog/inventory-mismanagement-destroys-margins",
    type: "article",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://snaptrack.io/blog/inventory-mismanagement-destroys-margins",
  },
};
  ...
  return (
    <ArticleLayout
      ...
      breadcrumbs={[
        ...
        {
                "label": "How Inventory Mismanagement Destroys Restaurant Profit Margins",
                "href": "/blog/inventory-mismanagement-destroys-margins"
        }
]}
    >
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "BlogPosting",
            headline: "How Inventory Mismanagement Destroys Restaurant Profit Margins",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          ...
          },
          {
                    "@type": "ListItem",
                    "position": 3,
                    "name": "How Inventory Mismanagement Destroys Restaurant Profit Margins",
                    "item": "https://snaptrack.io/blog/inventory-mismanagement-destroys-margins"
          }
],
          }),
        }}
      ...
      <p className="lead">
        The profit impact of poor inventory management. Over-ordering, waste, spoilage, and theft—how bad inventory practices kill restaurant margins.
      </p>

      <h2 id="introduction">Introduction</h2>

      <p>
        This comprehensive guide covers everything you need to know about how inventory mismanagement destroys restaurant profit margins. We'll explore industry best practices, proven strategies, and actionable insights from successful operators.
      </p>
      ...
      <p>
        Mastering how inventory mismanagement destroys restaurant profit margins requires commitment, consistency, and the right tools. By following the strategies outlined in this guide and avoiding common pitfalls, you'll be well-positioned for success.
      </p>
